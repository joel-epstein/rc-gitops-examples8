...
Whale16: gsl.#Service & {
	...
	context: Whale16.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale16"
	display_name:  "Examples Whale16"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale16 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale16 service.
