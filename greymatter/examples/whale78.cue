...
Whale78: gsl.#Service & {
	...
	context: Whale78.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale78"
	display_name:  "Examples Whale78"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale78 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale78 service.
