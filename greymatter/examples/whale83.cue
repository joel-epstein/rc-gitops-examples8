...
Whale83: gsl.#Service & {
	...
	context: Whale83.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale83"
	display_name:  "Examples Whale83"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale83 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale83 service.
