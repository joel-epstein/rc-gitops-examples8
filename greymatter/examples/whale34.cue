...
Whale34: gsl.#Service & {
	...
	context: Whale34.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale34"
	display_name:  "Examples Whale34"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale34 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale34 service.
