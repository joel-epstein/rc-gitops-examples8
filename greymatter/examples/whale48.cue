...
Whale48: gsl.#Service & {
	...
	context: Whale48.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale48"
	display_name:  "Examples Whale48"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale48 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale48 service.
