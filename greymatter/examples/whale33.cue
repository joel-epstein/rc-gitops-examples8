...
Whale33: gsl.#Service & {
	...
	context: Whale33.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale33"
	display_name:  "Examples Whale33"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale33 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale33 service.
