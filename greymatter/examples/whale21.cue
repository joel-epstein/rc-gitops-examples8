...
Whale21: gsl.#Service & {
	...
	context: Whale21.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale21"
	display_name:  "Examples Whale21"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale21 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale21 service.
