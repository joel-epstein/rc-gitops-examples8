...
Whale55: gsl.#Service & {
	...
	context: Whale55.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale55"
	display_name:  "Examples Whale55"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale55 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale55 service.
