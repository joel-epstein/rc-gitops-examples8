...
Whale67: gsl.#Service & {
	...
	context: Whale67.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale67"
	display_name:  "Examples Whale67"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale67 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale67 service.
