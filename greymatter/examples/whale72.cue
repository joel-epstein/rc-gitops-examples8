...
Whale72: gsl.#Service & {
	...
	context: Whale72.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale72"
	display_name:  "Examples Whale72"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale72 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale72 service.
