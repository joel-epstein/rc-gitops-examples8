...
Whale29: gsl.#Service & {
	...
	context: Whale29.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale29"
	display_name:  "Examples Whale29"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale29 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale29 service.
