...
Whale96: gsl.#Service & {
	...
	context: Whale96.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale96"
	display_name:  "Examples Whale96"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale96 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale96 service.
