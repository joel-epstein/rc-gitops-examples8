...
Whale65: gsl.#Service & {
	...
	context: Whale65.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale65"
	display_name:  "Examples Whale65"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale65 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale65 service.
