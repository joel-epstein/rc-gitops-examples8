...
Whale30: gsl.#Service & {
	...
	context: Whale30.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale30"
	display_name:  "Examples Whale30"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale30 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale30 service.
