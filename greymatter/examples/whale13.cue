...
Whale13: gsl.#Service & {
	...
	context: Whale13.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale13"
	display_name:  "Examples Whale13"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale13 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale13 service.
