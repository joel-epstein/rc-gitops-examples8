...
Whale26: gsl.#Service & {
	...
	context: Whale26.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale26"
	display_name:  "Examples Whale26"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale26 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale26 service.
