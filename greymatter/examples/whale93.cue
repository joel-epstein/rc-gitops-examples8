...
Whale93: gsl.#Service & {
	...
	context: Whale93.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale93"
	display_name:  "Examples Whale93"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale93 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale93 service.
