...
Whale92: gsl.#Service & {
	...
	context: Whale92.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale92"
	display_name:  "Examples Whale92"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale92 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale92 service.
