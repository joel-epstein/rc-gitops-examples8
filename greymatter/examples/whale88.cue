...
Whale88: gsl.#Service & {
	...
	context: Whale88.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale88"
	display_name:  "Examples Whale88"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale88 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale88 service.
