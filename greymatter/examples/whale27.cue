...
Whale27: gsl.#Service & {
	...
	context: Whale27.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale27"
	display_name:  "Examples Whale27"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale27 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale27 service.
