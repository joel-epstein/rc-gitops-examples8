...
Whale82: gsl.#Service & {
	...
	context: Whale82.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale82"
	display_name:  "Examples Whale82"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale82 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale82 service.
