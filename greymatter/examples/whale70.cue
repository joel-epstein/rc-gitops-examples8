...
Whale70: gsl.#Service & {
	...
	context: Whale70.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale70"
	display_name:  "Examples Whale70"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale70 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale70 service.
