...
Whale64: gsl.#Service & {
	...
	context: Whale64.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale64"
	display_name:  "Examples Whale64"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale64 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale64 service.
