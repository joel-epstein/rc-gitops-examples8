...
Whale19: gsl.#Service & {
	...
	context: Whale19.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale19"
	display_name:  "Examples Whale19"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale19 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale19 service.
