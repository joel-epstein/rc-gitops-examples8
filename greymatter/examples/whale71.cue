...
Whale71: gsl.#Service & {
	...
	context: Whale71.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale71"
	display_name:  "Examples Whale71"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale71 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale71 service.
