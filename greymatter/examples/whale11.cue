...
Whale11: gsl.#Service & {
	...
	context: Whale11.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale11"
	display_name:  "Examples Whale11"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale11 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale11 service.
