...
Whale84: gsl.#Service & {
	...
	context: Whale84.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale84"
	display_name:  "Examples Whale84"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale84 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale84 service.
