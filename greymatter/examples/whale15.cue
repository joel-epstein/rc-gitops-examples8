...
Whale15: gsl.#Service & {
	...
	context: Whale15.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale15"
	display_name:  "Examples Whale15"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale15 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale15 service.
