...
Whale77: gsl.#Service & {
	...
	context: Whale77.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale77"
	display_name:  "Examples Whale77"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale77 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale77 service.
