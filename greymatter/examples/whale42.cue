...
Whale42: gsl.#Service & {
	...
	context: Whale42.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale42"
	display_name:  "Examples Whale42"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale42 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale42 service.
