...
Whale12: gsl.#Service & {
	...
	context: Whale12.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale12"
	display_name:  "Examples Whale12"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale12 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale12 service.
