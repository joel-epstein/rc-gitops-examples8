...
Whale28: gsl.#Service & {
	...
	context: Whale28.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale28"
	display_name:  "Examples Whale28"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale28 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale28 service.
