...
Whale99: gsl.#Service & {
	...
	context: Whale99.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale99"
	display_name:  "Examples Whale99"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale99 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale99 service.
