...
Whale50: gsl.#Service & {
	...
	context: Whale50.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale50"
	display_name:  "Examples Whale50"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale50 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale50 service.
