...
Whale18: gsl.#Service & {
	...
	context: Whale18.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale18"
	display_name:  "Examples Whale18"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale18 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale18 service.
