...
Whale45: gsl.#Service & {
	...
	context: Whale45.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale45"
	display_name:  "Examples Whale45"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale45 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale45 service.
