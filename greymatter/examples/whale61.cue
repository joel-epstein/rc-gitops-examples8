...
Whale61: gsl.#Service & {
	...
	context: Whale61.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale61"
	display_name:  "Examples Whale61"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale61 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale61 service.
