...
Whale94: gsl.#Service & {
	...
	context: Whale94.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale94"
	display_name:  "Examples Whale94"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale94 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale94 service.
