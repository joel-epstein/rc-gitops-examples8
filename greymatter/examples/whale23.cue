...
Whale23: gsl.#Service & {
	...
	context: Whale23.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale23"
	display_name:  "Examples Whale23"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale23 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale23 service.
