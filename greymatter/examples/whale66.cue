...
Whale66: gsl.#Service & {
	...
	context: Whale66.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale66"
	display_name:  "Examples Whale66"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale66 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale66 service.
