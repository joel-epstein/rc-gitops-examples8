...
Whale59: gsl.#Service & {
	...
	context: Whale59.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale59"
	display_name:  "Examples Whale59"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale59 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale59 service.
