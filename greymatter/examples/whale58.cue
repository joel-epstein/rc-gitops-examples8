...
Whale58: gsl.#Service & {
	...
	context: Whale58.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale58"
	display_name:  "Examples Whale58"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale58 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale58 service.
