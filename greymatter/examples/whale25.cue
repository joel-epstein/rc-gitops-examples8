...
Whale25: gsl.#Service & {
	...
	context: Whale25.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale25"
	display_name:  "Examples Whale25"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale25 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale25 service.
