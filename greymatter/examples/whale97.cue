...
Whale97: gsl.#Service & {
	...
	context: Whale97.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale97"
	display_name:  "Examples Whale97"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale97 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale97 service.
