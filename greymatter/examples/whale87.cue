...
Whale87: gsl.#Service & {
	...
	context: Whale87.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale87"
	display_name:  "Examples Whale87"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale87 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale87 service.
