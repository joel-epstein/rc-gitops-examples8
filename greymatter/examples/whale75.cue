...
Whale75: gsl.#Service & {
	...
	context: Whale75.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale75"
	display_name:  "Examples Whale75"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale75 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale75 service.
