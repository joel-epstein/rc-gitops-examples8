...
Whale10: gsl.#Service & {
	...
	context: Whale10.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale10"
	display_name:  "Examples Whale10"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale10 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale10 service.
