...
Whale37: gsl.#Service & {
	...
	context: Whale37.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale37"
	display_name:  "Examples Whale37"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale37 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale37 service.
