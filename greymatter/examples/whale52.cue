...
Whale52: gsl.#Service & {
	...
	context: Whale52.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale52"
	display_name:  "Examples Whale52"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale52 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale52 service.
