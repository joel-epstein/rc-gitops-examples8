...
Whale53: gsl.#Service & {
	...
	context: Whale53.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale53"
	display_name:  "Examples Whale53"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale53 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale53 service.
