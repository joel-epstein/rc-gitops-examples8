...
Whale40: gsl.#Service & {
	...
	context: Whale40.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale40"
	display_name:  "Examples Whale40"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale40 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale40 service.
