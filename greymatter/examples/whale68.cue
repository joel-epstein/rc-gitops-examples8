...
Whale68: gsl.#Service & {
	...
	context: Whale68.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale68"
	display_name:  "Examples Whale68"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale68 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale68 service.
