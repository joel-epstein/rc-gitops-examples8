...
Whale47: gsl.#Service & {
	...
	context: Whale47.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale47"
	display_name:  "Examples Whale47"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale47 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale47 service.
