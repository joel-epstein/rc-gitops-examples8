...
Whale81: gsl.#Service & {
	...
	context: Whale81.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale81"
	display_name:  "Examples Whale81"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale81 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale81 service.
