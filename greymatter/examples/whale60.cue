...
Whale60: gsl.#Service & {
	...
	context: Whale60.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale60"
	display_name:  "Examples Whale60"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale60 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale60 service.
