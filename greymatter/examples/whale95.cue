...
Whale95: gsl.#Service & {
	...
	context: Whale95.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale95"
	display_name:  "Examples Whale95"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale95 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale95 service.
