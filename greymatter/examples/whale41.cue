...
Whale41: gsl.#Service & {
	...
	context: Whale41.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale41"
	display_name:  "Examples Whale41"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale41 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale41 service.
