...
Whale14: gsl.#Service & {
	...
	context: Whale14.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale14"
	display_name:  "Examples Whale14"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale14 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale14 service.
