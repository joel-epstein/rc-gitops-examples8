...
Whale100: gsl.#Service & {
	// A context provides global information from globals.cue
	// to your service definitions.
	context: Whale100.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale100"
	display_name:  "Examples Whale100"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale100 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale100 service.
