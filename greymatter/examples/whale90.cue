...
Whale90: gsl.#Service & {
	...
	context: Whale90.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale90"
	display_name:  "Examples Whale90"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale90 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale90 service.
