...
Whale86: gsl.#Service & {
	...
	context: Whale86.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale86"
	display_name:  "Examples Whale86"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale86 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale86 service.
