...
Whale89: gsl.#Service & {
	...
	context: Whale89.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale89"
	display_name:  "Examples Whale89"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale89 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale89 service.
