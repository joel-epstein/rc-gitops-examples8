...
Whale85: gsl.#Service & {
	...
	context: Whale85.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale85"
	display_name:  "Examples Whale85"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale85 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale85 service.
