...
Whale76: gsl.#Service & {
	...
	context: Whale76.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale76"
	display_name:  "Examples Whale76"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale76 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale76 service.
