...
Whale54: gsl.#Service & {
	...
	context: Whale54.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale54"
	display_name:  "Examples Whale54"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale54 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale54 service.
