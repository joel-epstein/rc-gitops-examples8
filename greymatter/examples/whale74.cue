...
Whale74: gsl.#Service & {
	...
	context: Whale74.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale74"
	display_name:  "Examples Whale74"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale74 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale74 service.
