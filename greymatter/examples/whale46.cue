...
Whale46: gsl.#Service & {
	...
	context: Whale46.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale46"
	display_name:  "Examples Whale46"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale46 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale46 service.
