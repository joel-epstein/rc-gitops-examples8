...
Whale49: gsl.#Service & {
	...
	context: Whale49.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale49"
	display_name:  "Examples Whale49"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale49 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale49 service.
