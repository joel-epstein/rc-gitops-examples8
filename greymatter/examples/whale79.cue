...
Whale79: gsl.#Service & {
	...
	context: Whale79.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale79"
	display_name:  "Examples Whale79"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale79 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale79 service.
