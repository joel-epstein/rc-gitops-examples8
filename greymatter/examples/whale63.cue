...
Whale63: gsl.#Service & {
	...
	context: Whale63.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale63"
	display_name:  "Examples Whale63"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale63 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale63 service.
