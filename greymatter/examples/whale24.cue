...
Whale24: gsl.#Service & {
	...
	context: Whale24.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale24"
	display_name:  "Examples Whale24"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale24 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale24 service.
