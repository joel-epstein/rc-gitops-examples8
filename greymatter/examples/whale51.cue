...
Whale51: gsl.#Service & {
	...
	context: Whale51.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale51"
	display_name:  "Examples Whale51"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale51 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale51 service.
