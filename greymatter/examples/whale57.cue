...
Whale57: gsl.#Service & {
	...
	context: Whale57.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale57"
	display_name:  "Examples Whale57"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale57 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale57 service.
