...
Whale38: gsl.#Service & {
	...
	context: Whale38.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale38"
	display_name:  "Examples Whale38"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale38 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale38 service.
