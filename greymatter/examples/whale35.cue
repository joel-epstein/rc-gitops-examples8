...
Whale35: gsl.#Service & {
	...
	context: Whale35.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale35"
	display_name:  "Examples Whale35"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale35 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale35 service.
