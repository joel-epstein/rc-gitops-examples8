...
Whale98: gsl.#Service & {
	...
	context: Whale98.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale98"
	display_name:  "Examples Whale98"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale98 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale98 service.
