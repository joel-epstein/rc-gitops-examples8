...
Whale22: gsl.#Service & {
	...
	context: Whale22.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale22"
	display_name:  "Examples Whale22"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale22 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale22 service.
