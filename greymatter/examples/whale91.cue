...
Whale91: gsl.#Service & {
	...
	context: Whale91.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale91"
	display_name:  "Examples Whale91"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale91 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale91 service.
