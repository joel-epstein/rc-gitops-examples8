...
Whale69: gsl.#Service & {
	...
	context: Whale69.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale69"
	display_name:  "Examples Whale69"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale69 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale69 service.
