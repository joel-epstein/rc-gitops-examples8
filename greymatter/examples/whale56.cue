...
Whale56: gsl.#Service & {
	...
	context: Whale56.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale56"
	display_name:  "Examples Whale56"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale56 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale56 service.
