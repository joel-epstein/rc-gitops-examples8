...
Whale44: gsl.#Service & {
	...
	context: Whale44.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale44"
	display_name:  "Examples Whale44"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale44 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale44 service.
