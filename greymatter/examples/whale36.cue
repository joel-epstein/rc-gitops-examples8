...
Whale36: gsl.#Service & {
	...
	context: Whale36.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale36"
	display_name:  "Examples Whale36"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale36 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale36 service.
