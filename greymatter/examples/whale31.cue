...
Whale31: gsl.#Service & {
	...
	context: Whale31.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale31"
	display_name:  "Examples Whale31"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale31 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale31 service.
