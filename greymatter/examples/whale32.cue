...
Whale32: gsl.#Service & {
	...
	context: Whale32.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale32"
	display_name:  "Examples Whale32"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale32 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale32 service.
