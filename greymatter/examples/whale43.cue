...
Whale43: gsl.#Service & {
	...
	context: Whale43.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale43"
	display_name:  "Examples Whale43"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale43 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale43 service.
