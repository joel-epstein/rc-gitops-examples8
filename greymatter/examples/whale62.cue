...
Whale62: gsl.#Service & {
	...
	context: Whale62.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale62"
	display_name:  "Examples Whale62"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale62 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale62 service.
