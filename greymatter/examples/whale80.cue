...
Whale80: gsl.#Service & {
	...
	context: Whale80.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale80"
	display_name:  "Examples Whale80"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale80 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale80 service.
