...
Whale39: gsl.#Service & {
	...
	context: Whale39.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale39"
	display_name:  "Examples Whale39"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale39 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale39 service.
