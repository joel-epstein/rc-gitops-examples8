...
Whale73: gsl.#Service & {
	...
	context: Whale73.#NewContext & globals

	// name must follow the pattern namespace/name
	name:          "whale73"
	display_name:  "Examples Whale73"
	version:       "v1.0.0"
	description:   "EDIT ME"
	...
	// Whale73 -> ingress to your container
	ingress: {
		(name): {
			gsl.#HTTPListener
			gsl.#MTLSListener
	...
	// Edge config for the Whale73 service.
